package graphics.app.dashboard.home;
...
public class NotationButton extends Pane implements Decorator, Listener, Animation {
    public final static NotationButton notationButton = new NotationButton();
    private final ToggleButton buttonControl = new ToggleButton();
    private final ToggleButton commentButton = new ToggleButton();
    private final VBox vBox = new VBox();
    private final VBox commentVbox = new VBox();
    private final CommentView commentView = CommentView.commentView;
...
//        vBox.setMinSize(30 * StandardParameter.SCALE, 30 * StandardParameter.SCALE);
//        vBox.setMaxSize(30 * StandardParameter.SCALE, 30 * StandardParameter.SCALE);
    ...
    public void setAnimation() {
        buttonControl.addEventHandler(MouseEvent.MOUSE_CLICKED, e -> {
            if (buttonControl.isSelected()) {
                vBox.setStyle("-fx-background-color: rgb(244,244,242);");
