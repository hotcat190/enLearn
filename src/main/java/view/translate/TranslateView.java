...
public class TranslateView extends HBox implements Decorator, Connector, Listener {
    ...
    public void set() {
        ...
        vBoxTo.setPrefSize(width * StandardParameter.SCALE, height * StandardParameter.SCALE);
        vBoxTo.setMinSize(width * StandardParameter.SCALE, height * StandardParameter.SCALE);
        vBoxTo.setMaxSize(width * StandardParameter.SCALE, height * StandardParameter.SCALE);
