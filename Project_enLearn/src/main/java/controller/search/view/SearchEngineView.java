package controller.search.view;
...
public class SearchEngineView extends VBox implements Decorator, Listener {
    ...
    private final ObservableList<String> dictionaryList = FXCollections.observableArrayList(SQLDictionary.getInstance().getDictionary());
    ...
    public void setListener() {
        listView.addEventHandler(MouseEvent.MOUSE_CLICKED, e -> {
            ...
            SQLDictionary.getInstance().putHistory(wordSelected);
            try {
