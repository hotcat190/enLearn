...
public class MenuController extends VBox implements Decorator, Listener, Animation {
    ...
    private final ToggleButton gameButton = new ToggleButton();
    ...
    public void setId() {
        ...
        gameButton.getStyleClass().add("menu-controller__button");
        ...
        gameButton.setId("menu-controller__button--game");
    ...
    public void set() {
        ...
        navigatorVBox.getChildren().addAll(homeButton, myDictionaryButton, translateButton, testButton,gameButton);
    ...
    public void setListener() {
        toggleGroup.getToggles().addAll(homeButton, translateButton, myDictionaryButton, testButton,gameButton);
    }
    ...
    public ToggleButton getGameButton() {
        return gameButton;
    }
    ...
    public void setAnimation() {
        controllerButton.addEventHandler(MouseEvent.MOUSE_CLICKED, e -> {
            if (this.getMaxWidth() == 150) {
                ...
                gameButton.setStyle("-fx-max-width: 23px;");
                ...
                gameButton.setStyle("-fx-max-width: 130px;");
        ...
        ImageView gameIcon = new ImageView(Objects.requireNonNull(getClass().getResource(
                "/image/game_dashboard_icon.png"
        )).toExternalForm());
        gameIcon.setFitHeight(size_icon);
        gameIcon.setFitWidth(size_icon);
        gameButton.setGraphic(gameIcon);
        new AnimationTimer() {
            @Override
            public void handle(long l) {
                if (gameButton.isSelected()) {
                    gameIcon.setImage(new Image(
                            Objects.requireNonNull(getClass().getResource(
                                    "/image/game_pressed_dashboard_icon.png"
                            )).toExternalForm()
                    ));
                } else {
                    gameIcon.setImage(new Image(
